...
class ReviewRepository {
  ...
  Future<void> updateReviewCommentReactions(String commentId, Map<String, dynamic> reactions) async {
    await SupabaseService.instance
        .from('review_comments')
  ...
  Future<void> updateReviewCommentReactionsByShareToken(String token, String commentId, Map<String, dynamic> reactions) async {
    final client = SupabaseService.instance;
    try {
      client.rest.headers['x-share-token'] = token;
      await client
